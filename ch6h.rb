...
CHAPTER 6 - Acquiring Behavior Through Inheritance, Implementing Every Template Method pg. 127
=end
...
class Bicycle
  ...
  def initialize(args={})                 # <- WHY THE args={} ???
    ...
    @tire_size = args[:tire_size] || default_tire_size   # <- Not implemented in Bicycle
  end
